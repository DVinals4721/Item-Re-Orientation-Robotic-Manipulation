...
class UR5Sim():
    ...
    def __init__(self, camera_attached=False):
        ...
        self.ROBOT_URDF_PATH = os.path.join(os.getcwd(),"UR5/ur_e_description/urdf/ur5e.urdf")
        self.TABLE_URDF_PATH = os.path.join(pybullet_data.getDataPath(), "table/table.urdf")
    ...
    def load_robot(self):
        ...
        table = pybullet.loadURDF(self.TABLE_URDF_PATH, [0.5, 0, -0.6300], [0, 0, 0, 1])
        robot = pybullet.loadURDF(self.ROBOT_URDF_PATH, [0, 0, 0], [0, 0, 0, 1], flags=flags)
        return robot
